            ...
            >
                <div className="AddressModal__content flex flex-col gap-12">
                    ...
                    <form className="flex flex-col gap-4 w-full" onSubmit={handleSubmit(onSubmit)}>
                        ...
                        <button type="submit" className="w-full p-4 bg-accent rounded-[16px] text-white font-semibold">{lang?.['Добавить']}</button>
                    </form>
                </div>
                <button onClick={handleClose} className="absolute top-6 right-6 flex flex-col items-center justify-center">
